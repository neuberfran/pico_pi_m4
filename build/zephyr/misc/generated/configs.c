...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x1fff8000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_IMX_UART_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_IMX7D_PINCTRL_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IMX_HAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IMX_GPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IMX_I2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_IMX_IOMUXC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PICO_PI_M4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_IMX7_M4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_IMX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_MCIMX7_M4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_CONSOLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_CONSOLE_BUFFER_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_SEGGER_RTT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_IMX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_IMX_MAX_DATA_SIZE_16, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_IMX_MAX_DATA_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_IMX_MAX_ID_VAL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_IMX, 1);
